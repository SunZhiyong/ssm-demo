...
function addNotebook(){
	...
	$.post(url, data, function(result){
		if(result.state==SUCCESS){
			...
			$(document).data('notebookId', notebook.id);
...
var noteTemplate = '<li class="online note">'+
	'<a>'+
	'<i class="fa fa-file-text-o" title="online" rel="tooltip-bottom"></i> <span>[title]<span><button type="button" class="btn btn-default btn-xs btn_position btn_slide_down btn-note-menu"><i class="fa fa-chevron-down"></i></button>'+
	'</a>'+
...
var notebookTemplate = 
	...
	'rel="tooltip-bottom"></i> <span>[name]<span></a>'+
	'</li>';
